...
fun buildMediaSourceFactory(context: Context, dataSourceFactory: DataSource.Factory, playerView: PlayerView?): MediaSource.Factory {
...
@OptIn(UnstableApi::class)
fun buildMediaSourceWithHeaders(context: Context, videoSource: VideoSource, playerView: PlayerView?): MediaSource {
  val dataSourceFactory = buildDataSourceFactory(context, videoSource)
  val mediaSourceFactory = buildMediaSourceFactory(context, dataSourceFactory, playerView)
